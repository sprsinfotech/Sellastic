    ...
    <div class="content-wrapper">
        ...
        <nav class="top-toolbar navbar navbar-mobile navbar-tablet">
            ...
            <ul class="navbar-nav nav-center site-logo">
                <li>
                    <a href="https://control.sellasticopvtltd.com/">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <figure class="tint">
                                    ...
                                    <img src="<?=base_url();?>/resource/img/demos/ecom-header.jpg" alt="">
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <ul class="navbar-nav nav-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        ...
                        <img src="<?=base_url();?>/resource/img/avatars/1.jpg" class="w-35 rounded-circle"
                            alt="Albert Einstein">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                        <div class="dropdown-header pb-3">
                            <div class="media d-user">
                                <img class="align-self-center mr-3 w-40 rounded-circle"
                                    src="<?=base_url();?>/resource/img/avatars/1.jpg" alt="Albert Einstein">
                        ...
                        <a class="dropdown-item" href="#"><i class="icon dripicons-mail"></i>
                            Message <span
                                class="badge badge-accent rounded-circle w-15 h-15 p-0 font-size-10">4</span></a>
                        <a class="dropdown-item" href=""><i class="icon dripicons-user"></i>
                            Profile</a>
                        <a class="dropdown-item" href="#"><i class="icon dripicons-gear"></i>
                            Account Settings </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="icon dripicons-lock"></i> Lock Account</a>
                        <a class="dropdown-item" href="<?=base_url('home/logout/');?>"><i class="icon dripicons-lock-open"></i>
                            Sign Out</a>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="actions top-right">
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-icon-menu dropdown-menu-right">
                                ...
                                <a href="https://control.sellasticopvtltd.com/" class="dropdown-item">
